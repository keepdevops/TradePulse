#!/usr/bin/env python3
"""
TradePulse AI - Training Engine (Refactored)
...
from .training_engine_core import TrainingEngineCore
...
class TrainingEngine:
    ...
    def __init__(self):
        ...
        self._refactored_engine = TrainingEngineCore()
    ...
    def validate_training_config(self, model_config: Dict, training_data: Dict, 
        ...
        # Delegate to refactored implementation
        return self._refactored_engine.validate_training_config(model_config, training_data, hyperparameters)
