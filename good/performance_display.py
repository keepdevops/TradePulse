#!/usr/bin/env python3
"""
TradePulse Integrated Panels - Performance Display
...
from .performance_display_refactored import PerformanceDisplay as RefactoredPerformanceDisplay
...
class PerformanceDisplay:
    ...
    def __init__(self, performance_metrics):
        ...
        self._refactored_display = RefactoredPerformanceDisplay(performance_metrics)
