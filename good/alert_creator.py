#!/usr/bin/env python3
"""
TradePulse Modular Panels - Alert Creator
...
from .alert_creator_refactored import AlertCreator as RefactoredAlertCreator
...
class AlertCreator:
    ...
    def __init__(self):
        ...
        self._refactored_creator = RefactoredAlertCreator()
    
    def create_components(self):
        """Create alert creation components"""
        # Delegate to refactored implementation
        return self._refactored_creator.create_components()
