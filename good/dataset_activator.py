...
from .dataset_activator_refactored import DatasetActivator as RefactoredDatasetActivator
...
class DatasetActivator:
    ...
    def __init__(self, data_manager, module_name: str):
        ...
        self._refactored_activator = RefactoredDatasetActivator(data_manager, module_name)
