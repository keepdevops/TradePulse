#!/usr/bin/env python3
"""
TradePulse Demo Panels - Chart Factory
...
from .chart_factory_refactored import ChartFactory as RefactoredChartFactory
...
class ChartFactory:
    ...
    def __init__(self, data_generator):
        ...
        self._refactored_factory = RefactoredChartFactory(data_generator)
